...
void sira::profilepatient()
{
    ...
    if(n==1)
    {
        ...
        if(num==1)
        {
            ...
            f_name[size]=a;l_name[size]=b;
        }
        else if(num==2)
        {
            cout<<"Enter New Address: ";cin>>adr;
            address[size]=adr;
        }
        else if(num==3)
        {
            cout<<"Enter New Number: ";cin>>txt;
            phone[size]=txt;
            txt=0;
        }
        else if(num==4)
        {
            cout<<"Enter Chitizenship: ";cin>>txt;
            phone[size]=txt;
            txt=0;
        }
        else if(num==5)
        {
            cout<<"Enter Blood Group: ";cin>>adr;
            blood[size]=adr;
        }
        else if(num==6)
        {
            cout<<"Enter New Email: ";cin>>adr;
            mail[size]=adr;
        }
        else if(num==7)
        {
            cout<<"Enter New Number: ";cin>>adr;
            medicine[size]=adr;
        }
        else if(num==8)
        {
        ...
        {
            cout<<"Enter Parents Number: ";cin>>txt;
            parentspn[size]=txt;
            txt=0;
        }
    }
...
void sira::visitprof()
{
    long long data;
    int n,k=4;
    cout<<"Enter Phone Number or\nCitizenShip Number: ";cin>>data;
    for(int i=0;i<count;i++)
    {
        if(data==phone[i]||data==iD[i])
        {
            cout<<"Data Found!!\n";
            cout<<"Enter Unique Number to access: ";
            cin>>n;
            if(n==unique[i])
            {
                cout<<"Blood Group: "<<blood[i]<<endl;
                cout<<"Any Medicine consumption: "<<medicine[i]<<endl;
                cout<<"Address: "<<address[i]<<endl;
                cout<<"Parents Number: "<<parentspn[i]<<endl;
            }
            else{
                if(k=0)
                {
                    ...
                    cout<<"Wrong Input!! You have "<<k<<" times left to try\n";
                    k--;
                }
            }
        }
...
void sira::signUpDoctor()
{
    ...
    double f, g, h, i, j,m;
    cout << "Enter your Name: ";cin >> a >> b;
    cout<<"Enter your NMC number: ";cin>>m;
    cout << "Address: ";cin >> l;
    cout << "Enter blood group: ";cin >> c;
    cout << "Enter if consuming any medicine (else write NO): ";cin >> d;
    cout << "Enter your mail Id: ";cin >> k;
    ...
    int abc = 10000;
    cout << rand() % abc << endl;
    cout << "Enter a user ID (must be greater than 4 digits): ";cin >> i;
    cout << "Enter password: ";cin >> e;
    f_name1[count1] = a;
    l_name1[count1] = b;
    address1[count1] = l;
